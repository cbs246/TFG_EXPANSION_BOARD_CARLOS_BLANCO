...
/**
 * @brief Activa el interruptor de un pin de la GPIO
 *
 * @param pin Pin de la GPIO (índices de 0 a 15)
 * @param priority Nivel de prioridad (prioridad más alta: 0, prioridad más baja: 15)
 * @param subpriority Nivel de subprioridad (prioridad más alta: 0, prioridad más baja: 15)
 *
 * @retval Nada
 */
...
/**
 * @brief Desactiva el interruptor de un pin de la GPIO
 *
 * @param pin Pin de la GPIO (índices de 0 a 15)
 *
 * @retval Nada
...
/**
 * @brief Lee el valor digital de la GPIO.
 *
 * @param Port Puerto de la GPIO (structura CMSIS)
 * @param pin  Pin de la GPIO (índices de 0 a 15)
 *
 * @retval Nada
*/
...
/**
 * @brief Escribe un valor digital en la GPIO.
 * 
 * @param p_port Puerto de la GPIO (structura CMSIS)
 * @param pin Pin de la GPIO (índices de 0 a 15)
 * @param value Valor booleano para poner la GPIO en ALTO (1, true) o BAJO (0, false) 
 *
 * @retval Nada
*/
...
/**
 * @brief Pone al sistema en el modo STOP para el menor consumo de potencia. 
 *
 * @retval Nada
*/
...
/**
 * @brief Pone al sistema en el modo SLEEP para el menor consumo de potencia. 
 *
 * @retval Nada
*/
...
/**
 * @brief Suspende que cada 1ms el sistema se esté despertando. 
 *
 * @retval Nada
*/
...
/**
 * @brief Vuelve a poner el refresco cada 1ms.
 *
 * @retval Nada
*/
...
/**
 * @brief Activa el bajo consumo de energía cuando esta en el modo SLEEP.
 *
 * @retval Nada
*/
